...
\frame{
\frametitle{Why is GPL code put back}
\begin{itemize}
\item Android's ToolBox is quite minimal
\item other tools are missing (firewalling)
\end{itemize}
...
\begin{itemize}
\item practical issues : enormous burden on the shoulders of Google
\item legal issue: marketplace terms are related to trademarks, not copyright
\item legal issue: if Google checks, but makes a mistake, they create precedence, opening a whole new can of legal worms
\end{itemize}
